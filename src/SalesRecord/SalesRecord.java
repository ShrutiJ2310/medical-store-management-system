...
ResultSet rs = null;
 ...
 String tableClicked = "";
    ...
    private void updateTable(){
        ...
        try{
          String sql = "SELECT id as 'ID', customer_name as 'Customer Name', product_name as 'Product Name', company_name as 'Company Name', date_of_sale as 'Date of Sale', quantity as 'Quantity', amount as 'Amount' FROM sales_record";
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        try{
            String sql = "SELECT id as 'ID', customer_name as 'Customer Name', product_name as 'Product Name', company_name as 'Company Name', date_of_sale as 'Date of Sale', quantity as 'Quantity', amount as 'Amount' FROM sales_record WHERE customer_name LIKE ? OR product_name LIKE ? OR company_name LIKE ?";
            pst = conn.prepareStatement(sql);

...
double[] amountPerRows;
    ...
    private void initComponents() {
        ...
        customerNameTxt.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(customerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addComponent(customerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(customerNameTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public void insertAllProducts(double val){
       DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        ...
        try{
            int rowsCount  = cartTable.getRowCount();
            for(int i =0;i < rowsCount; i++){
               String sql  = "INSERT INTO sales_record(customer_name, product_name,company_name,date_of_sale,quantity,amount) VALUES (?,?,?,?,?,?)";
                pst = conn.prepareStatement(sql);
                pst.setString(1, customerNameTxt.getText());
                pst.setString(2, cartTable.getValueAt(i, 2).toString());
                pst.setString(3, cartTable.getValueAt(i, 0).toString());
                pst.setString(4, df.format(calobj.getTime()));
                pst.setString(5, cartTable.getValueAt(i, 3).toString());
                pst.setString(6, String.valueOf(val));
                pst.execute();
            }
        }catch(Exception e){
